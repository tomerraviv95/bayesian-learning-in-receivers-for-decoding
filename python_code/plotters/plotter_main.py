...
if __name__ == '__main__':
    ...
    elif plot_type is PlotType.hidden_size:
        means_bers_dict = get_mean_ber_list(all_curves)
        means_sers_dict = get_mean_ser_list(all_curves)
        means_ece_dict = get_mean_ece_list(all_curves)
        plot_dict_vs_list(values_dict=means_bers_dict, to_plot_by_values=to_plot_by_values, xlabel='Hidden Size', ylabel='BER',
                          plot_type=plot_type, loc='lower left', legend_type=LEGEND_TYPE.FULL)
        plot_dict_vs_list(values_dict=means_sers_dict, to_plot_by_values=to_plot_by_values, xlabel='Hidden Size', ylabel='SER',
                          plot_type=plot_type, loc='lower left', legend_type=LEGEND_TYPE.FULL)
        plot_dict_vs_list(values_dict=means_ece_dict, to_plot_by_values=to_plot_by_values, xlabel='Hidden Size', ylabel='ECE',
