...
if __name__ == '__main__':
    ...
    plot_type = PlotType.basic  # Choose the plot among the three Figures
    print(plot_type.name)
    run_params_obj = RunParams(run_over=run_over, trial_num=trial_num)
    params_dicts, xlabel, ylabel = get_config(plot_type)
    all_curves = []
    ...
    plot_by_values(all_curves, xlabel, ylabel, plot_type)
